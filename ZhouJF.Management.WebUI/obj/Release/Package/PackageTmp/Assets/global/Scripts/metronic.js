...
function numberFormat(number, decimals, decPoint, thousandsSep) {
    ...
    /// 数值格式化
    /// </summary>
    /// <param name="number">待格式化的数值</param>
    /// <param name="decimals">小数位数</param>
    /// <param name="decPoint">小数点地带符号</param>
    /// <param name="thousandsSep">千分位符号</param>
...
var Metronic = function () {
    ...
    // Handle Date and Datetime control
    var handleDatetime = function () {
        $(".form-control.date").attr("onfocus", "WdatePicker({dateFmt:'yyyy/MM/dd'})");


        $(".form-control.datetime").attr("onfocus", "WdatePicker({dateFmt:'yyyy/MM/dd HH:mm:ss'})");
        $(".form-control.month").attr("onfocus", "WdatePicker({dateFmt:'yyyy/MM'})");
    };

    // Handle Date and Datetime control
    var handleNumberBox = function () {
        $(".form-control.integer").on({
            "keypress": function () {
