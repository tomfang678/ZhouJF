...
(function( $ ){ 
	var methods = {
		...
		init : function( options )
		{
			...
			var box = document.getElementById("onTable");
			if (box)
			    box.parentNode.removeChild(box);
		    var containerDiv = $("<div id=\"onTable\"/>",{ class : "row-fluid Editor-container" });
			var $this = $(this).hide();	       	
		...
		setStyleWithCSS:function(){
			if(!navigator.userAgent.match(/Chrome/) && !navigator.userAgent.match(/Firefox/)){	//for IE10
				try {
