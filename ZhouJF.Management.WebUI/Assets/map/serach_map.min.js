$(function () {
    ...
    function a(n) {
        var t = [], i, r; if (n !== undefined) {
            for (i = 0; i < n.length; i++) t.push('<div class="serach_house_item">'),
                t.push("<a href=/Home/Detail?ID=" + n[i].SourceId + ' target="_blank" class="mulch"><\/a>'), t.push("<a href=" + n[i].Url + ' target="_blank">'),
    ...
    function v() {
        ...
        $(".inputName").val() === "" ? n.push('<p class="housing">没有检索到房源<\/p>') : n.push('<p class="housing">请选择右侧道路<' + $(".inputName").val() + "><\/p>");
