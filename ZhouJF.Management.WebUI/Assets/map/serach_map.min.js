    ...
    function a(n) {
        var t = [], i, r; if (n !== undefined) {
            for (i = 0; i < n.length; i++) t.push('<div class="serach_house_item">'),
                t.push("<a href=/RoadBasicInfo/Detail?ID=" + n[i].ID + ' target="_blank" class="mulch"><\/a>'), t.push("<a href=" + n[i].picture + ' target="_blank">'),
                t.push('<div class="house_preview" style="background:url(' + n[i].picture + ') no-repeat;background-size:100% 100%;">'),
