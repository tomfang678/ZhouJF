...
if ("undefined" != typeof staticFileRoot) {
    ...
    //document.write('<link rel="stylesheet" type="text/css" href="' + staticFileRoot + '/Assets/Uploadify/uploadify.v3.2.css"/>');
    //document.write('<script type="text/javascript" src="' + staticFileRoot + '/Assets/Uploadify/jquery.uploadify.v3.2.min.js"></script>');
    document.write('<link rel="stylesheet" type="text/css" href="' + staticFileRoot + '/Assets/uploadify3.2.1/uploadify.css"/>');
    document.write('<script type="text/javascript" src="' + staticFileRoot + '/Assets/uploadify3.2.1/jquery.uploadify.min.js"></script>');

    $.fn.FileUpload = function (param) {

        var uploadparam = {
            'swf': '/Assets/uploadify3.2.1/uploadify.swf',
