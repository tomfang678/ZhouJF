function pageReady() {
    var grid = $('#grid').dataTableExtention({
        ...
        "sAjaxSource": "/BfUser/QueryBfUser",
        "lockLastColumn": true,
        "aoColumns": [
    { "mDataProp": "CODE", "mMaxWidth": "250px", "sWidth": "250px" },
{ "mDataProp": "NAME", "mMaxWidth": "250px", "sWidth": "250px" },
{ "mDataProp": "ORG_NAME", "mMaxWidth": "250px", "sWidth": "250px" },
{ "mDataProp": "EXPIRE_TIME", "mMaxWidth": "250px", "sWidth": "250px" },
{ "mDataProp": "LAST_CHANGPWD_DATE", "mMaxWidth": "250px", "sWidth": "250px" },
                ...
                "columnDefs": [
                    {
                        ...
                        "render": function (data, type, row) {
                            ...
                            if ($("#hidIsEdit").val() == "True") {
                                html.push("<a href=\"/BfUser/Edit/{0}\" class=\"btn default btn-xs green\"><i class=\"fa fa-edit\"></i> 编辑 </a>");
                            } else {
                                html.push("<label class=\"btn default btn-xs green\" style=\"cursor:default\"><i class=\"fa fa-edit\"></i> 编辑 </label>");
                            }
                            if ($("#hidIsChangePwd").val() == "True") {
                                html.push("<a href=\"/BfUser/ChangePwd/{0}\" class=\"btn default btn-xs green\"><i class=\"fa fa-edit\"></i> 修改密码 </a>");
                            } else {
                                html.push("<label class=\"btn default btn-xs green\" style=\"cursor:default\"><i class=\"fa fa-edit\"></i> 修改密码 </label>");
                            }
