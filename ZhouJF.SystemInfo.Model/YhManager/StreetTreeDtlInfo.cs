...
namespace YHPT.SystemInfo.Model.YhManager
{
    ...
    /// </summary> 
    [DataContract]
    [MB.Orm.Mapping.Att.ModelMap("StreetTreeDtlInfo", "StreetTreeDtlInfo", new string[] { "ID" })]
    [KnownType(typeof(StreetTreeDtlInfo))]
    public class StreetTreeDtlInfo : MB.Orm.Common.BaseModel
    {

        public StreetTreeDtlInfo()
        {
        ...
        private string _IsDisturbPeopleName;
        [DataMember]
        [MB.Orm.Mapping.Att.ColumnMap("IsDisturbPeopleName", System.Data.DbType.String)]
        public String IsDisturbPeopleName
        {
            get { return _IsDisturbPeopleName; }
            set { _IsDisturbPeopleName = value; }
        }
