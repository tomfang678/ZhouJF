...
namespace YHPT.SystemInfo.Model.YhManager
{
    ...
    [KnownType(typeof(StreettreedtlinfoInfo))]
    public class StreettreedtlinfoInfo : MB.Orm.Common.BaseModel
    {

        public StreettreedtlinfoInfo()
        {
        ...
        private int? _StreetTreeInfoID;
        [DataMember]
        [MB.Orm.Mapping.Att.ColumnMap("StreetTreeInfoID", System.Data.DbType.Int32)]
        public int? StreetTreeInfoID
        {
            get { return _StreetTreeInfoID; }
            set { _StreetTreeInfoID = value; }
        }
